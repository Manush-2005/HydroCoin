import { BarChart2, NotebookTabs, LogOut, BarChart, Home } from "lucide-react";
...
const SIDEBAR_ITEMS = [
  { name: "Dashboard", icon: Home, color: "#6366f1", href: "/trading/dashboard" },
  { name: "Trade", icon: BarChart, color: "#00ff9d", href: "/trading/trade" },
  { name: "History", icon: NotebookTabs, color: "#8B5CF6", href: "/trading/history" },
