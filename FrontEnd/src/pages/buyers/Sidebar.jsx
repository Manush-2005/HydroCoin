...
const SIDEBAR_ITEMS = [
  ...
  { name: "Pending Requests", icon: BarChart2, color: "6366f1", href: "/government/pending-requests" },
  { name: "Approved Requests", icon: NotebookTabs, color: "#00ff9d", href: "/government/approved-requests" },
